...
public class TNAutoSync : TNBehaviour
{
	...
	private bool Cache()
	{
		...
		for (int i = 0; i < mList.size; i++)
		{
			...
			object obj = ((extendedEntry.field != null) ? (obj = extendedEntry.field.GetValue(extendedEntry.target)) : (obj = extendedEntry.property.GetValue(extendedEntry.target, null)));
