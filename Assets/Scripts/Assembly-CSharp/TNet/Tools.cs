...
namespace TNet
{
	public static class Tools
	{
		...
		public static int randomPort
		{
			get
			{
				return 10000 + (int)(DateTime.UtcNow.Ticks % 50000);
			}
		}
			...
			get
			{
				if (mAddresses == null)
				{
					...
					try
					{
						...
						while (num > 0)
						{
							NetworkInterface networkInterface = list[--num];
		...
		public static IPAddress localAddress
		{
			...
			set
			{
				...
				Console.WriteLine(string.Concat("[TNet] ", value, " is not one of the local IP addresses. Strange things may happen."));
			}
		}
